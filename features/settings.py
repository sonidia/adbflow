...
class SettingsWidget(QWidget):
    ...
    def _build_ui(self):
        ...
        btn_dark_on.setToolTip("Enable Dark Mode")
        ...
        btn_dark_off.setToolTip("Disable Dark Mode")
        ...
        btn_bt_on.setToolTip("Enable Bluetooth")
        ...
        btn_bt_off.setToolTip("Disable Bluetooth")
        ...
        display_vl.setContentsMargins(12, 10, 12, 10)
        ...
        self._dpi_input.setToolTip("Set the screen density (DPI)")
        ...
        btn_dpi_set.setToolTip("Set DPI density")
        ...
        btn_dpi_reset.setToolTip("Reset DPI density")
        ...
        self._res_input.setToolTip("Set the screen resolution (WxH)")
        ...
        btn_res_set.setToolTip("Set screen size")
